...
set ::env(OSU_STD_CELL_LIBRARY) gf180mcu_osu_sc_gp9t3v3
puts $::env(OSU_STD_CELL_LIBRARY)
...
#set ::env(LIB_SYNTH) "$::env(PDK_ROOT)/$::env(PDK)/libs.ref/gf180mcu_osu_sc_gp9t3v3/liberty/gf180mcu_osu_sc_gp9t3v3_TT_25C.ccs.lib"
set ::env(LIB_SYNTH) "$::env(PDK_ROOT)/$::env(PDK)/libs.ref/gf180mcu_osu_sc_gp9t3v3/liberty/gf180mcu_osu_sc_gp9t3v3_TT_25C.nldm.lib"
...
puts $::env(SYNTH_LATCH_MAP)
puts $::env(TRISTATE_BUFFER_MAP)
puts $::env(FULL_ADDER_MAP)
puts $::env(RIPPLE_CARRY_ADDER_MAP)
puts $::env(CARRY_SELECT_ADDER_MAP)
puts $::env(DRC_EXCLUDE_CELL_LIST)
puts $::env(DRC_EXCLUDE_CELL_LIST_OPT)
puts $::env(RCX_RULES)
...
## Tracks info
set ::env(TRACKS_INFO_FILE) "$::env(PDK_ROOT)/$::env(PDK)/libs.tech/openlane/gf180mcu_fd_sc_mcu7t5v0/tracks.info"
