...
set leffile=LOCAL_PREFIX/gf180mcuB/libs.ref/gf180mcu_fd_sc_mcu7t5v0/lef/gf180mcu_fd_sc_mcu7t5v0.lef

# The SPICE netlist containing subcell definitions for all the standard cells

set spicefile=LOCAL_PREFIX/gf180mcuB/libs.ref/gf180mcu_fd_sc_mcu7t5v0/spice/gf180mcu_fd_sc_mcu7t5v0.spice

# The liberty format file containing standard cell timing and function information

set libertyfile=LOCAL_PREFIX/gf180mcuB/libs.ref/gf180mcu_fd_sc_mcu7t5v0/liberty/gf180mcu_fd_sc_mcu7t5v0__ss_1p62v_125c.lib
...
set techleffile=LOCAL_PREFIX/gf180mcuB/TECHLEF_PATH/gf180mcu_fd_sc_mcu7t5v0.nom.tlef
...
set gdsfile=LOCAL_PREFIX/gf180mcuB/libs.ref/gf180mcu_fd_sc_mcu7t5v0/gds/gf180mcu_fd_sc_mcu7t5v0.gds	;# GDS database of standard cells
set verilogfile=LOCAL_PREFIX/gf180mcuB/libs.ref/gf180mcu_fd_sc_mcu7t5v0/verilog/gf180mcu_fd_sc_mcu7t5v0.v	;# Verilog models of standard cells
